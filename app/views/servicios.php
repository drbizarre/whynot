    	...
    	<div class="container clearfix">
            ...
            <div class="tabbable servicetab tabs-left">
              <ul class="nav nav-tabs">
                <li <?php echo (isset($section) && $section=='dev')?'class="active"':''; ?>><a href="#webdesign" data-toggle="tab"><i class="fa fa-laptop"></i> Desarrollo Web</a></li>
                <li <?php echo (isset($section) && $section=='des')?'class="active"':''; ?>><a href="#webdevelopment" data-toggle="tab"><i class="fa fa-cogs"></i> Diseño Web</a></li>
                <li <?php echo (isset($section) && $section=='seo')?'class="active"':''; ?>><a href="#seoservices" data-toggle="tab"><i class="fa fa-bar-chart-o"></i> SEO</a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane <?php echo (isset($section) && $section=='dev')?'active':''; ?>" id="webdesign">
                ...
                <div class="tab-pane <?php echo (isset($section) && $section=='des')?'active':''; ?>" id="webdevelopment">
