...
<html class="no-js" lang="en">
    ...
    <title>¿Why not? | Agencia Tecnológica en Tijuana</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
	<meta name="author" content="">
	<link rel="shortcut icon" href="favicon.ico">
	<link href="http://www.whynot.mx/assets/images/favicon.ico" rel="icon" />
	...
	<!-- Switcher Only -->
	<link rel="stylesheet" id="switcher-css" type="text/css" href="switcher/css/green.css" media="all" />
    <!-- END Switcher Styles -->

	<!-- Demo Examples -->
	<link rel="alternate stylesheet" type="text/css" href="switcher/css/orange.css" title="orange" media="all" />
	<link rel="alternate stylesheet" type="text/css" href="switcher/css/turquoise.css" title="orange" media="all" />
	...
	<link rel="alternate stylesheet" type="text/css" href="switcher/css/brown.css" title="brown" media="all" />
	<link rel="alternate stylesheet" type="text/css" href="switcher/css/dark.css" title="dark" media="all" />
	<link rel="alternate stylesheet" type="text/css" href="switcher/css/rose.css" title="rose" media="all" />
...
<body>
		...
		<div id="slider-wrapper">
			<div id="layerslider" style="width:100%;height:550px;">
                ...
                <div class="ls-slide" data-ls="slidedelay:8000;transition2d:21,105;timeshift:-1000;">
                    ...
                    <img class="ls-l" style="top:80px;left:52%;white-space: nowrap;" data-ls="durationin:1500;scalexin:0.8;scaleyin:0.8;scalexout:0.8;scaleyout:0.8;" src="sliderimages/ls5box.png" alt="">
	...
	<section class="section3 withpadding">
		<div class="container">
                <div class="general-title text-center">
                    <h3>SERVICIOS</h3>
                    <p>Nuestros más populares servicios listados abajo</p>
                    <hr>
                </div>
	...
	<section class="section1">              
        <div class="general-title text-center">
            <h3>PORTAFOLIO</h3>
            <p>Conoce nuestros proyectos casos de éxito en posicionamiento en buscadores, diseño de páginas web y desarrollo de sistemas de información.</p>
            <hr>
        </div>
                                
        <nav class="portfolio-filter clearfix">
            <ul>
                <li><a href="#" class="dmbutton2" data-filter="*">Todos</a></li>
                <li><a href="#" class="dmbutton2" data-filter=".mockups">Diseño</a></li>
                <li><a href="#" class="dmbutton2" data-filter=".graphic-design">SEO</a></li>
                <li><a href="#" class="dmbutton2" data-filter=".web-design">E-Commerce</a></li>
            </ul>
        </nav>
        ...
        <div class="portfolio-centered">
            ...
            <a class="btn btn-primary btn-lg">MIRA TODO EL TRABAJO</a>
            <div class="divider"></div>
        </div>
	</section><!-- section3 -->
    ...
    <section class="section1">
    	<div class="container clearfix">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <h4 class="title">Social Media Profiles</h4>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="servicebox text-center">
                        <div class="service-icon">
                            <div class="dm-icon-effect-1" data-effect="slide-bottom">
                                <a href="#" class=""> <i class="active dm-icon fa fa-github fa-3x"></i> </a>
                            </div>
                            <div class="servicetitle">
                            <h4>Github</h4>
                            </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="servicebox text-center">
                        <div class="service-icon">
                            <div class="dm-icon-effect-1" data-effect="slide-right">
                                <a href="#" class=""> <i class="dm-icon fa fa-linkedin fa-3x"></i> </a>
                            </div>
                            <div class="servicetitle">
                            <h4>Linkedin</h4>
                            </div>
